...
The data used for the YOLO-GAT PCB component classification model can be downloaded from [YOLO-GAT PCB Component Classification Dataset](). Store it locally.
